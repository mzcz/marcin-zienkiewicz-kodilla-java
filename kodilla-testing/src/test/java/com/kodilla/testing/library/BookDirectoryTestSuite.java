...
public class BookDirectoryTestSuite {
    ...
    public void testlistBooksInHandsOfNoneBorrowedBooks() {
        ...
        LibraryUser libraryUser = new LibraryUser("M","Z", "89");
    ...
    @Test
    public void testlistBooksInHandsOneBorrowedBooks() {
        // Given
        List<Book> resultListOfOneBooks = generateListOfNBooks(1);
        LibraryUser libraryUser = new LibraryUser("Ma","Zi", "89");
    ...
    public void testlistBooksInHandsOfFiveBorrowedBooks() {
        ...
        LibraryUser libraryUser = new LibraryUser("Mar","Zie", "89");
